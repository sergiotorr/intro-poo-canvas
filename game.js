...
class Game { 
    constructor() { 
        ...
        this.balls = [
            new Ball(canvas.width / 2, canvas.height / 2, 10, 4, 4, 'red'),
            new Ball(canvas.width / 2, canvas.height / 2, 15, 3, 3, 'blue'),
            new Ball(canvas.width / 2, canvas.height / 2, 20, 5, 2, 'green'),
            new Ball(canvas.width / 2, canvas.height / 2, 12, 2, 5, 'yellow'),
            new Ball(canvas.width / 2, canvas.height / 2, 8, 4, 3, 'pink')
        ];
